// Below : Web APIs Code Quiz Questions! 
// Includes the questions, choices/options, answers
...
var questions = [
    ...
    {
        title: "Which is an example of an API?",
        chocies: ["YouTube API", "Google Maps API", "Amazon Advertising API", "All the Above" ],
    ...
    {
        title:  "Which technology is Web API built on top of?",
        choices: ["if statements", "curl", "fetch", "HTTP"],
        answer: "HTTP"
    }, 
